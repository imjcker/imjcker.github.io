...
7. 安装最新版本的Docker CE 和containerd

   ```text
   sudo apt-get install docker-ce docker-ce-cli containerd.io
   ```

8. 通过测试 `hello-world` 镜像来确认是否安装成功.
...
2. MacOS 右键点击桌面顶栏的 docker 图标，选择 Preferences ，在 Daemon 标签（Docker 17.03 之前版本为 Advanced 标签）下的 Registry mirrors 列表.
3. 111
